...
notes: "仕入れ価格: 28,000円。〇〇骨董市で入手。ベルトは新品に交換済み。"
---

## 商品詳細

1970年代に製造されたSEIKOの自動巻き腕時計です。

### 特徴
- ケース径: 36mm
- ムーブメント: 自動巻き（Cal.7005）
- 文字盤: シルバー（経年による焼け有り）
- 風防: ミネラルガラス

### コンディション
専門店でオーバーホール済み。精度は日差+10秒程度で実用に問題ありません。
ケースには使用に伴う小傷がありますが、ヴィンテージ品としては良好な状態です。
